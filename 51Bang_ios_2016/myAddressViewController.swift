...
class myAddressViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,UIAlertViewDelegate{
    var row = Int()
    var userid = NSString()
...
//        let userid = ud.objectForKey("userid")as! String
    ...
    func createTableView(){
        ...
        button.setTitle("添加新地址", forState: UIControlState.Normal)
