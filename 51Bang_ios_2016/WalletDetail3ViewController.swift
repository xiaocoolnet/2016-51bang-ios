//
//  WalletDetail3ViewController.swift
//  51Bang_ios_2016
//
//  Created by Pencil on 16/9/22.
...
class WalletDetail3ViewController:UIViewController,UITableViewDataSource,UITableViewDelegate {
...
//            myTableView = UITableView.init(frame: CGRectMake(0, 15, WIDTH, 180))
            ...
            buttonQueren.addTarget(self, action: #selector(getCashGo(_:)), forControlEvents: UIControlEvents.TouchUpInside)
